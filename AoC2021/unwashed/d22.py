...
def insert_cuboid(cuboids, cuboid, state):
    ...
    # print('updated with', ext)
    cuboids.extend(ext)


def get_ext_cuboid_area(coords):
    # print('coords', coords)
    ...
    return (coords[1][0] - coords[0][0] + 1) * (coords[1][1] - coords[0][1] + 1) * (coords[1][2] - coords[0][2] + 1)
