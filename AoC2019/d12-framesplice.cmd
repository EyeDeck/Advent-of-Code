...
set fps=30
ffmpeg -y -f image2 -r %fps% -i frame%%06d.png -vf fps=%fps% -an -c:v libvpx -t 120s -b:v 160k -crf 6 -quality best -pass 1 -f rawvideo NUL
ffmpeg -y -f image2 -r %fps% -i frame%%06d.png -vf fps=%fps% -an -c:v libvpx -t 120s -b:v 160k -crf 6 -quality best -pass 2 ..\%1%.webm